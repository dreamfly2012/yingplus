...
$(document).ready(function() {
    $("#weixin").click(function() {
        $(this).addClass('option_2').parent().siblings().children("#zfb").removeClass('option_2');
    });
    $("#zfb").click(function() {
        $(this).addClass('option_2').parent().siblings().children("#weixin").removeClass('option_2');
    });

    var telephone = getParameterValue('telephone');
    if(telephone!=null){
    	$('#activity_telephone').val(telephone);
    	$('#telephone_span').text(telephone);
    	$('.change_telephone').text('修改手机号');
    }
    ...
    $(".change_telephone").click(function(){
        ...
        window.location.href = leave_movie_activity_telephone_url+'?backurl='+backurl;
    });

    $('.go_to_pay').click(function(){
        if(is_login=='true'){
            $('.deal_form_submit').trigger('click');
        }else{
            jump_login_page();
        }
